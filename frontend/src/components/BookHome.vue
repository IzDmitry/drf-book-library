<template>
    <div class="books__header">
        <h2 class="books__title">
            <router-link to="/books/" class="text-white">Library</router-link>
        </h2>
        ...
        <div class="books__meta">
            <button class="meta__link">
                <router-link to="/books/" class="link-text">Get Books</router-link>
            </button>
        </div>

        <div class="books__meta">
            <button class="meta__link">
                <router-link to="/user/" class="link-text">Create User</router-link>
            </button>
        </div>
    </div>
